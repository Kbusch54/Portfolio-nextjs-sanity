  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        alt="pic"
        className="-mb-20  md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[380px] xl:h-[400px]"
      />
      <div className="spaxe-y-10 px-0 md:px-10">
